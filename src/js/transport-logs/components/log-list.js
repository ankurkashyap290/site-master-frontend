...
import Row from 'transport-logs/containers/row.js';

const TransportLogTable = props => (
  <Table className="list transport-logs" ref={(el) => { props.setPrintContent(el); }}>
    <TableHead>
...
TransportLogTable.defaultProps = {
  pagination: null,
};

TransportLogTable.propTypes = {
...
export default TransportLogTable;
