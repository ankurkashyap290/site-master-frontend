...
const transportBillingLogReducer = (state = {}, action) => {
  switch (action.type) {
    case SET_MODEL_LIST: {
    ...
    case SET_EDITABLE_MODEL: {
      ...
      return Object.assign(
        {},
        state,
        { editableModel: Object.assign({}, transportBillingLogSkeleton, action.editableModel) },
      );
    }
...
export default transportBillingLogReducer;
