...
const TransportBillingLogFilterComponent = props => (
  <div>
...
TransportBillingLogFilterComponent.defaultProps = {
  printContent: null,
};

TransportBillingLogFilterComponent.propTypes = {
  setFilterType: PropTypes.func.isRequired,
  printContent: PropTypes.object,
};

export default TransportBillingLogFilterComponent;
