...
import OrganizationSidebarFormComponent from '../components/sidebar-form';
...
class OrganizationSidebarForm extends CrudContainer {
  constructor(props) {
    super(props);
    this.state = {
      editableModel: null,
  ...
  render() {
    return (
      <OrganizationSidebarFormComponent
...
OrganizationSidebarForm.defaultProps = {
  editableModel: null,
};

OrganizationSidebarForm.propTypes = {
...
const mapStateToProps = ({ organizationReducer, authReducer }) => ({
  isOpen: organizationReducer.editableModel !== null,
  editableModel: organizationReducer.editableModel,
